...
export default function ShareButtons({ title, url }: Props) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs text-gray-400 font-medium uppercase tracking-widest">Share</span>
      <a
      ...
      <a
        ...
        className="p-2 rounded-sm border border-gray-200 text-gray-500 hover:border-green-600 hover:border-green-600 hover:text-green-600 transition-colors"
      >
