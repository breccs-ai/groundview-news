/**
 * Country list used by writer application form (country dropdown + phone dial code selector).
 * Each entry: ISO-3166-1 alpha-2 code, English short name, international dial code (without +).
 */
